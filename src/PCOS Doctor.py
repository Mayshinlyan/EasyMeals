...
def main():
    ...
    if (
        "initial_questions_answered" not in st.session_state
        and st.session_state.get("onboarded") == "no"
    ):
        ...
        with st.form("initial_questions_form"):
            ...
            if submitted:
                ...
                st.session_state["NumOfDay"] = NumOfDay
                ...
                insert_patients_value = (
                    ...
                    "1",
                    st.session_state.get("favFood"),
                    st.session_state.get("dislikeFood"),
                    want_breakfast,
                    want_lunch,
                    want_dinner,
                    want_snack,
